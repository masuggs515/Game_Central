...
const ProfileEdit = () => {
    ...
    const handleSubmit = async e => {
        ...
        let savedUser;
        try {
            savedUser = await GameAPI.editProfileEdit(currUser.username, formData)
    ...
    return (
        <div className='ProfileEdit' style={{height: '89.75vh'}}>
            <h1>Edit {currUser.username}'s Profile</h1>
